...
MANIFEST="${VALIDATION_MANIFEST:-/root/autodl-tmp/outputs/p39_single_scene_quality_push/01_704_dataset/dataset_33f_704/validation_manifest.jsonl}"
...
OUT="${VALIDATION_OUT:-$ROOT/validation/full4_704}"
...
exec "$PY" "$ROOT/04_validation/p38_validate.py" \
  ...
  --output-dir "$OUT" --label h672_925_infer704 --lora "$LORA" \
